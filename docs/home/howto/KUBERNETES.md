...
All of them have [default configuration](https://github.com/lambdastack/lambdastack/blob/develop/data/common/defaults/configuration/applications.yml). The common parameters are: name, enabled, namespace, image_path and use_local_image_registry.  
...
The default applications configuration available [here](https://github.com/lambdastack/lambdastack/blob/develop/data/common/defaults/configuration/applications.yml)
