...
List of all security groups and related services in Azure are described [here](https://github.com/lambdastack/lambdastack/blob/develop/data/azure/defaults/infrastructure/virtual-machine.yml).
...
List of all security groups and related services in AWS are described [here](https://github.com/lambdastack/lambdastack/blob/develop/data/aws/defaults/infrastructure/virtual-machine.yml).
